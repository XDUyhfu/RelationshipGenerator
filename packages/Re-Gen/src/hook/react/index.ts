...
export function useReGen(CacheKey: string, RelationConfig: IConfigItem[] | IConfigItem[][], config?: ReGenConfig): IResultAtomsValue;
export function useReGen(CacheKey: string, RelationConfig: Record<string, IConfigItem[]> | Record<string, IConfigItem[][]>, config?: ReGenConfig): IResultRecordAtomsValue;
export function useReGen(CacheKey: string, RelationConfig: IRelationConfig, config?: ReGenConfig): any {
